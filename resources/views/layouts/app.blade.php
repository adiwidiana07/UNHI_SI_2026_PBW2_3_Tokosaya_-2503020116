    ...
    <header class="bg-gray-dark sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center py-4">
            ...
            <a href="{{ url('/') }}" class="flex items-center">
              <div>
                  <img src="{{ asset('assets/tailstore/img/template-white-logo.png') }}" alt="Logo" class="h-14 w-auto mr-4">
              </div>
            </a>
            ...
            <nav class="hidden lg:flex md:flex-grow justify-center">
              <ul class="flex justify-center space-x-4 text-white">
                  ...
                  <li class="relative group" x-data="{ open: false }">
                      <a href="{{ url('/shop') }}" @mouseover="open = true" @mouseleave="open = false" class="hover:text-secondary font-semibold flex items-center">
                          Men
                      ...
                      >
                          <li><a href="{{ url('/shop') }}" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Men Item 1</a></li>
                          <li><a href="{{ url('/shop') }}" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Men Item 2</a></li>
                          <li><a href="{{ url('/shop') }}" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Men Item 3</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="relative group" x-data="{ open: false }">
                      ...
                      <ul
                          ...
                          x-transition:leave-end="opacity-0 scale-90"
                      >
                          <li><a href="{{ url('/shop') }}" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Women Item 1</a></li>
                          <li><a href="{{ url('/shop') }}" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Women Item 2</a></li>
                          <li><a href="{{ url('/shop') }}" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Women Item 3</a></li>
                      </ul>
                  </li>

                  <li><a href="{{ url('/shop') }}" class="hover:text-secondary font-semibold">Shop</a></li>
                  <li><a href="{{ url('/product') }}" class="hover:text-secondary font-semibold">Product</a></li>
      ...
      <ul class="w-full">
          ...
          <li class="relative group" x-data="{ open: false }">
              ...
              <ul class="mobile-dropdown-menu" x-show="open" x-transition class="space-y-2">
                  <li><a href="{{ url('/shop') }}" class="hover:text-secondary font-bold block pt-2 pb-3">Shop Men</a></li>
                  <li><a href="{{ url('/product') }}" class="hover:text-secondary font-bold block py-2">Men item 1</a></li>
                  <li><a href="{{ url('/product') }}" class="hover:text-secondary font-bold block py-2">Men item 2</a></li>
                  <li><a href="{{ url('/product') }}" class="hover:text-secondary font-bold block py-2">Men item 3</a></li>
              </ul>
          </li>
          ...
          <li class="relative group" x-data="{ open: false }">
              ...
              <ul class="mobile-dropdown-menu" x-show="open" x-transition class="pl-4 space-y-2">
                  <li><a href="{{ url('/shop') }}" class="hover:text-secondary font-bold block py-2">Shop Women</a></li>
                  <li><a href="{{ url('/product') }}" class="hover:text-secondary font-bold block py-2">Women item 1</a></li>
                  <li><a href="{{ url('/product') }}" class="hover:text-secondary font-bold block py-2">Women item 2</a></li>
                  <li><a href="{{ url('/product') }}" class="hover:text-secondary font-bold block py-2">Women item 3</a></li>
              </ul>
          </li>

          <li><a href="{{ url('/shop') }}" class="hover:text-secondary font-bold block py-2">Shop</a></li>
          <li><a href="{{ url('/product') }}" class="hover:text-secondary font-bold block py-2">Product</a></li>
          <li><a href="{{ url('/checkout') }}" class="hover:text-secondary font-bold block py-2">Checkout</a></li>
      </ul>
        ...
        <div class="container mx-auto px-4 py-10">
          <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full sm:w-2/6 px-4 mb-8">
              ...
              <p><img src="{{ asset('assets/tailstore/img/template-logo.png') }}" alt="Logo" class="h-[60px] mb-4"></p>
